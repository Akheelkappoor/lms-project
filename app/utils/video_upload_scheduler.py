...
def schedule_video_upload_reminders(class_id, tutor_id):
    ...
    try:
        ...
        one_hour_reminder = completion_time + timedelta(hours=12)  # 12 hours after completion
        final_warning = completion_time + timedelta(hours=23)     # 1 hour before deadline
        deadline = completion_time + timedelta(hours=24)
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: #f8f9fa; padding: 20px; border-radius: 8px;">
                ...
                <div style="background: white; padding: 15px; border-radius: 6px; margin: 15px 0;">
                    ...
                    ⏳ Deadline: {deadline.strftime('%I:%M %p')} (12 hours remaining)
                </div>
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: #f8d7da; padding: 20px; border-radius: 8px; border: 2px solid #dc3545;">
                ...
                <div style="background: #721c24; color: white; padding: 15px; border-radius: 6px; text-align: center; margin: 15px 0;">
                    <strong style="font-size: 18px;">⏰ 1 HOUR REMAINING ⏰</strong>
                </div>
                ...
                <div style="background: #dc3545; color: white; padding: 15px; border-radius: 6px;">
                    <strong>⚠️ WARNING:</strong> If you don't upload the video within 1 hour:
...
def get_meeting_link_availability(class_obj):
    ...
    # Links available until 24 hours after class ends
    class_end = class_datetime + timedelta(minutes=class_obj.duration)
    link_available_until = class_end + timedelta(hours=24)
